...
def launch_customtkinter(*args):
    ...
    left_arrow_button = CTkButton(arrow_btn_frame, text='<', command=left_arrow_button_pressed, width=60, font=h2_font)
    left_arrow_button.pack(side=LEFT, padx=10, pady=10)

    right_arrow_button = CTkButton(arrow_btn_frame, text='>', command=right_arrow_button_pressed, width=60, font=h2_font)
